...
![](Coursera_practical_ML_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](Coursera_practical_ML_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](Coursera_practical_ML_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](Coursera_practical_ML_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
![](Coursera_practical_ML_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
The predicted outcome for the Test_data set using the RandomForest Model is **B, A, B, A, A, E, D, B, A, A, B, C, B, A, E, E, A, B, B, B**
